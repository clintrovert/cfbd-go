...
- [API Methods](#api-methods)
  - [Games](#games)
    ...
    - [GetAdvancedBoxScore](#getadvancedboxscore)
    - [GetCalendar](#getcalendar)
    - [GetScoreboard](#getscoreboard)
  - [Teams](#teams)
    - [GetTeams](#getteams)
    - [GetFBSTeams](#getfbsteams)
    - [GetTeamRecords](#getteamrecords)
    - [GetTeamMatchup](#getteammatchup)
    - [GetTeamATS](#getteamats)
    - [GetRoster](#getroster)
    - [GetTeamTalentComposite](#getteamtalentcomposite)
  - [Players](#players)
    - [SearchPlayers](#searchplayers)
    - [GetPlayerUsage](#getplayerusage)
    - [GetReturningProduction](#getreturningproduction)
    - [GetTransferPortalPlayers](#gettransferportalplayers)
  - [Plays and Drives](#plays-and-drives)
    - [GetPlays](#getplays)
    - [GetPlayTypes](#getplaytypes)
    - [GetPlayStats](#getplaystats)
    - [GetPlayStatTypes](#getplaystattypes)
    - [GetLivePlays](#getliveplays)
    - [GetDrives](#getdrives)
  - [Statistics](#statistics)
    - [GetPlayerSeasonStats](#getplayerseasonstats)
    - [GetTeamSeasonStats](#getteamseasonstats)
    - [GetAdvancedSeasonStats](#getadvancedseasonstats)
    - [GetAdvancedGameStats](#getadvancedgamestats)
    - [GetHavocGameStats](#gethavocgamestats)
    - [GetStatCategories](#getstatcategories)
  - [Ratings](#ratings)
    - [GetTeamSPPlusRatings](#getteamspplusratings)
    - [GetConferenceSPPlusRatings](#getconferencespplusratings)
    - [GetSRSRatings](#getsrsratings)
    - [GetEloRatings](#geteloratings)
    - [GetFPIRatings](#getfpiratings)
  - [Rankings](#rankings)
    - [GetRankings](#getrankings)
  - [Betting](#betting)
    - [GetBettingLines](#getbettinglines)
  - [Recruiting](#recruiting)
    - [GetPlayerRecruitingRankings](#getplayerrecruitingrankings)
    - [GetTeamRecruitingRankings](#getteamrecruitingrankings)
    - [GetTeamPositionGroupRecruitingRankings](#getteampositiongrouprecruitingrankings)
  - [Metrics](#metrics)
    - [GetPredictedPoints](#getpredictedpoints)
    - [GetTeamsPPA](#getteamsppa)
    - [GetGamesPPA](#getgamesppa)
    - [GetPlayersPPA](#getplayersppa)
    - [GetPlayerSeasonPPA](#getplayerseasonppa)
    - [GetWinProbability](#getwinprobability)
    - [GetPregameWinProbability](#getpregamewinprobability)
    - [GetFieldGoalExpectedPoints](#getfieldgoalexpectedpoints)
  - [Adjusted Metrics (Patreon Required)](#adjusted-metrics-patreon-required)
    - [GetTeamSeasonWEPA](#getteamseasonwepa)
    - [GetPlayerPassingWEPA](#getplayerpassingwepa)
    - [GetPlayerRushingWEPA](#getplayerrushingwepa)
    - [GetPlayerKickingWEPA](#getplayerkickingwepa)
  - [Draft](#draft)
    - [GetDraftTeams](#getdraftteams)
    - [GetDraftPositions](#getdraftpositions)
...
- [Patreon Subscriptions](#patreon-subscriptions)
- [Examples](#examples)
- [License](#license)
